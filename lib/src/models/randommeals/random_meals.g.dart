...
part of 'random_meals.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

RandomMeals _$RandomMealsFromJson(Map<String, dynamic> json) {
  return RandomMeals(
      randomMealsItem: (json['meals'] as List)
          ?.map((e) => e == null
              ? null
              : RandomMealsItem.fromJson(e as Map<String, dynamic>))
          ?.toList());
}
...
Map<String, dynamic> _$RandomMealsItemToJson(RandomMealsItem instance) =>
    <String, dynamic>{
